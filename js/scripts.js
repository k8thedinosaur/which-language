...
$(document).ready(function() {
  $("form").submit(function(event) {
    ...
    // var question4 = $("input:radio[name=question2]:checked").val();
    // if (question4 === "python") {
    //   python +=1;
    ...
    // var question5 = $("input:radio[name=question2]:checked").val();
    // if (question5 === "python") {
    //   python +=1;
    ...
    // var question6 = $("input:radio[name=question2]:checked").val();
    // if (question6 === "python") {
    //   python +=1;
    ...
    // var question7 = $("input:radio[name=question2]:checked").val();
    // if (question7 === "python") {
    //   python +=1;
    ...
    // var question8 = $("input:radio[name=question2]:checked").val();
    // if (question8 === "python") {
    //   python +=1;
    ...
    // var question9 = $("input:radio[name=question2]:checked").val();
    // if (question9 === "python") {
    //   python +=1;
    ...
    // var question10 = $("input:radio[name=question2]:checked").val();
